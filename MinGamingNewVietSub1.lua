...
local Window = OrionLib:MakeWindow({Name = "Võ Lâm Anh", HidePremium = false, IntroText = "Võ Lâm Anh Library", SaveConfig = true, ConfigFolder = "Võ Lâm Anh"})
----------Tab-----------------------
